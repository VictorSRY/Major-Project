...
function PTButtonDrop() {
    ...
    if (f) {
        ...
        obj.innerHTML += '<ul id="PTlist"><li style="margin:0px;"><a class="tabOptions tabOptionsSelect" href="SelectTopicPage.jsp">Topics</li></a><li><a class="tabOptions tabOptionsSelect" href="MockTestPaper.jsp">Mock Test</a></li></ul>';
